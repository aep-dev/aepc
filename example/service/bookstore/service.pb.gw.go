...
var (
	filter_BookStore_CreateBook_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func RegisterBookStoreHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BookStoreServer) error {
	...
	mux.Handle("POST", pattern_BookStore_CreateBook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/.BookStore/CreateBook", runtime.WithHTTPPathPattern("/book"))
		if err != nil {
...
func RegisterBookStoreHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BookStoreClient) error {
	...
	mux.Handle("POST", pattern_BookStore_CreateBook_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/.BookStore/CreateBook", runtime.WithHTTPPathPattern("/book"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
