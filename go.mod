...
require (
	...
	github.com/aep-dev/terraform-provider-aep v0.0.0-20241021202055-6e899642070a // indirect
	github.com/aep-dev/terraform-provider-openapi v0.0.0-20241021202055-6e899642070a // indirect
